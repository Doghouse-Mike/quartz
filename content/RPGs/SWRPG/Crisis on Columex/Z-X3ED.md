...
![](https://raw.githubusercontent.com/Doghouse-Mike/quartzpics/main/assets/20260625T234601962Z.jpg)

Character info for [[RPGs/SWRPG/Crisis on Columex/SWRPG]]
...
![](https://raw.githubusercontent.com/Doghouse-Mike/quartzpics/main/assets/20260625T234604620Z.jpeg)
...
> this was decided against. I still like the name though.
...
Get a [Repulsor Fist](https://star-wars-rpg-ffg.fandom.com/wiki/Repulsor_Fist) grafted on as a third arm. Techpriest stylee. Start saving then, that's got a list price of 4750 Cr. Would need to confer with GM whether we'd first need to get a [Cybernetic arm](https://star-wars-rpg-ffg.fandom.com/wiki/Cybernetic_Arms_\(Mod_V_and_Mod_VI\)) to graft it onto (feels like it) for 10,000 Cr (but a bonus point into _either_ Brawn or Agility). Could potentially wrangle a deal to combine the two for less than the separate purchase prices. Cheaper option is a "[Replacement" Limb](https://star-wars-rpg-ffg.fandom.com/wiki/Prosthetic_Replacement) for 2000 Cr, but no bonus from that.
...
## Updated after [[Crisis on Columex 20260814]]

Skipping over whatever progression has been made previously, with 30XP stowed away, and that rank in dedication dangling _right there_, a decision needs to be made.

Ed is currently:

- Brawn 2 / Agility 3 / Intellect 2 / Cunning 3 / Willpower 2 / Presence 2
- Smuggler → Scoundrel
- The party’s dedicated Face
- Reasonably strong in the Cunning-based social/scoundrel stuff

So I considered Dedication (25 XP) and three possible characteristics:

#### Agility 4

- immediate combat improvement.
- But largely doubles down on something he’s holding his own at (whiffed shots aside)
- Could be deferred until we know whether combat actually needs the boost, or if that can be offset with more ranks in Ranged light, or better gear, or both.

#### Cunning 4

- Improves Ed’s existing Deception/Skulduggery/Perception/etc.
- Also boosts [Soft Spot](https://star-wars-rpg-ffg.fandom.com/wiki/Soft_Spot_talent) (when acquired) since that adds damage equal to Cunning.
- again, he’s already above average at Cunning 3

#### Presence 3

- strengthens Charm (already a class skill) and Coercion, and lets him develop a different approach to social interactions.

### The Big Alternative Specialisations Were:

#### [Gadgeteer](https://star-wars-rpg-ffg.fandom.com/wiki/Gadgeteer)

- Weapon/armour tinkering, Jury Rigged, Tinkerer, etc.
- Leans a bit into combat, but also on being able to upgrade that gear that could again improve combat viability (mods, attachments, crafting)

#### [Outlaw Tech](https://star-wars-rpg-ffg.fandom.com/wiki/Outlaw_Tech)

- More genuinely technical.
- Better fit for the potential “Ed can actually repair and modify shit” idea.
...
[[RPGs/SWRPG/Crisis on Columex/Nira Keth]] (Shiv's character)

[[RPGs/SWRPG/Character Creation Ideas (for Future reference)]]
